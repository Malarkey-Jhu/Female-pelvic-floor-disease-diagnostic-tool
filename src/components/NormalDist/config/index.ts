...
export const AGE_LSC_NM = getNMByExcelVal(50.32, 62.13, "AGE");
export const AGE_SLFF_NM = getNMByExcelVal(62.13, 7.32, "AGE");
export const AGE_ULS_NM = getNMByExcelVal(50.85, 9.37, "AGE");
export const AGE_PVTM_NM = getNMByExcelVal(61.33, 6.21, "AGE");
...
export const BMI_PVTM_NM = getNMByExcelVal(25.55,2.72, "BMI");
...
export const ANTERIOR_PVTM_NM = getNMByExcelVal(0.87,1.58, "ANTERIOR");
...
export const CENTRAL_PVTM_NM = getNMByExcelVal(2.96, 3.61, "CENTRAL");
...
export const POSTERIOR_PVTM_NM = getNMByExcelVal(5.33, 0.84, "POSTERIOR");
